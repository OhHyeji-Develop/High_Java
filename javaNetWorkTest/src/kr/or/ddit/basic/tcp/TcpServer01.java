...
public class TcpServer01 {
	...
	public static void main(String[] args) throws IOException {
		// TCP소켓 통신을 하기위해 ServerSocket객체를 생성한다.
		...
		System.out.println("접속된 현재 컴퓨터의 정보");
		...
		// 데이러틀 보내려면 OutputStream이 필요, 데이터를 받으려면 InputStream이 필요
		// (Socket의 getOutputStream()메서드를 이용한다.)
		OutputStream out = socket.getOutputStream();
		// 문자열만 전송하는 메서드를 쓰기위해 DataOutputStream 보조스트림 사용
