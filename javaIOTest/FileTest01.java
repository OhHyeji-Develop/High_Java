...
public class FileTest01 {
	...
	public static void main(String[] args) {
		...
		File file1 = new File("D:\\D_Other\\test.txt");	// 구분문자로 '\\' 사용 (역슬래쉬 사용시 두번씩\\)
		
		System.out.println("파일명 : " + file1.getName());	// 파일의 이름 출력
		...
		/*
		 - mkdir() => File객체의 경로 중에서 마지막 위치의 디렉토리를 생성한다.
		   	  빈환값 => 만들기 성공 : true, 만들기 실패 : false 
		   	       => 중간 부분의 경로가 모두 만들어져 있어야 마지막 위치의 경로를 만들수 있다.
