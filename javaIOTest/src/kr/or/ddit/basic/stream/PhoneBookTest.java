...
public class PhoneBookTest {
	...
	/*
	 * 선생님 풀이 public PhoneBookTest() { phoneBookMap = new HashMap<String, Phone>();
	 ...
	 * }
	 * 
	 * // 전화번호 정보 전체 자료를 출력하는 메서드 private void displayAll(){ System.out.println();
	 * 
	 * 모든 key값 가져오기 Set<String> phoneKeySet = phoneBookMap.keySet();
	 * System.out.println("번호    이름    전화번호    주소"); if(phoneKeySet.size()==0){
	 * System.out.println("등록된 전화번호가 없습니다."); }else{ for cnt = 0; for(String name :
	 * phoneKeySet){ cnt++; phone p = phoneBookMap.get(name); System.out.println(cnt
	 * + " " + name + " " + p.getTel() + " " + p.getAddr()); } }
	 * System.out.println("출력 끝"); }
	 */

	/*
	 * 전화번호 정보를 수정하는 메서드 private void update() { System.out.println();
	 * System.out.println("수정할 전화번호 정보를 입력하세요"); System.out.print("이름>>"); String
	 * name = scan.next(); //입력한 사람의 이름이 전화번호목록에 없으면....
	 * if(!phoneBookMap.containsKey(name)) { System.out.println(name +
	 * "씨는 등록되지 않은 사람입니다."); System.out.println("수정작업을 마칩니다."); return; }
	 * 
	 * System.out.print("수정할 전화번호>>"); String newTel = scan.next();
	 * 
	 * System.out.print("수정할 주소>>"); String newAddr = scan.next();
	 * 
	 * phoneBookMap.put(name, newTel, newAddr); System.out.println(name +
	 * "님의 전화번호 수정완료!"); }
	 */

	/*
	 * 삭제 private void delete() { System.out.println("삭제할 이름을 입력하세요");
	 * System.out.print("이름>>"); String name = scan.next();
	 * 
	 * //containsKey로 이름이 있나없나 확인 if(!phoneBookMap.containsKey(name)) {
	 * System.out.println(name + "씨는 등록되지 않은 사람입니다.");
	 * System.out.println("수정작업을 마칩니다."); return; }
	 * 
	 * phoneBookMap.remove(name); System.out.println(name + "님의 전화번호 정보 삭제완료!");
	 * 
	 * }
	 */

	/*
	 * 검색 private void search() { System.out.println("검색할 전화번호 정보를 입력하세요."); String
	 * name = scan.next();
	 * 
	 * if(!phoneBookMap.containsKey(name)) { System.out.println(name +
	 * "씨는 등록되지 않은 사람입니다."); System.out.println("검색작업을 마칩니다."); return; }
	 * 
	 * Phone p = phoneBookMap.get(name); System.out.println(name + "님의 전화번호정보");
	 * System.out.println("---------------------------"); System.out.println("이름 : "
	 * + p.getName()); System.out.println("전화번호 : " + p.getTel());
