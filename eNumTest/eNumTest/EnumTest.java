 ...
 * 	 	=> 클래스처럼 보이게하는 상수
 * 	 	=> 열거형은 클래스처럼 독립된 java파일로 만들 수 있고, 하나의 java파일에 클래스와 같이 만들 수 있고, 클래스 안에 내부 클래스처럼 만들 수 있다.	
 * 
 * 	 - 열거형의 속성 및 메서드
 ...
 *   		 enum 열거형이름 {
 *   		 	상수명1(값들...),  // 하나의 상수에 값을 여러개 설정가능
 *   			상수명2(값들...),
 *   			...
 *   			상수명n(값들...);  // 마지막 상수를 지정한 후에 세미콜론을 붙힌다.
 *   
 *   			// '값들'이 저장될 변수들을 선언한다...
 *   			private 자료형이름 변수명1;
 *   			....
 ...
 *   			
 *   			// 변수명의 개수는 '값들'의 개수와 같아야 하고 각 변수들의 자료형도 '값들'의 자료형과 같아야한다.
...
public class EnumTest {
	...
	public enum Season{
		...
		// 열거형의 생성자 작성하기
		// => 열거형의 생성자의 접근 제한자는 무조건 private이어야 한다.
	...
	public static void main(String[] args) {
		...
		*/
		...
		Color mycol = Color.valueOf("GREEN");  //COLOR열거형에서 GREEN이라고하는 속성값을 가져오기 == Color.GREEN과 같음
		Count mycnt = Count.THREE;  // COUNT열거형에서 바로 속성값 가져오기 == Count.THREE와 같음
		...
		*/
		...
		// switch문에서의 비교...
		switch(mycnt) {
		case ONE : // case문에 지정하는 열거형값은 열거형이름을 뺀 상수명만 사용해야한다.
			System.out.println("하나..."); break;
		case TWO : // case문에 지정하는 열거형값은 열거형이름을 뺀 상수명만 사용해야한다.
			System.out.println("둘..."); break;
		case THREE : // case문에 지정하는 열거형값은 열거형이름을 뺀 상수명만 사용해야한다.
